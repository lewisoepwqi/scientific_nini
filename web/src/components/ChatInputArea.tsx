...
export default function ChatInputArea() {
 ...
 <div className="mb-3 rounded-lg border border-[var(--success)] bg-[var(--accent-subtle)]/80 px-4 py-3 text-sm text-[var(--success)]">
 <div className="flex flex-wrap items-center justify-between gap-3">
 <div>
 命中推荐模板：
 <span className="ml-1 font-semibold">{suggestedRecipe.name}</span>
 <div className="mt-1 text-xs text-[var(--success)]">{suggestedRecipe.summary}</div>
 </div>
 ...
 className="rounded-full border-[var(--success)] px-3 py-1.5 text-xs text-[var(--success)]"
 >
 继续自由对话
 </Button>
 </div>
 ...
 <div
        className="relative rounded-lg border border-[var(--border-default)] bg-[var(--bg-base)] px-3 py-2 shadow-sm"
 ...
 <div className="mt-0.5 text-[11px] text-[var(--text-secondary)]">{skill.description}</div>
 ...
 <div className="border-t px-2.5 py-1.5 text-[10px] text-[var(--text-muted)] dark:border-[var(--border-default)]">
 ...
 className={`relative h-8 px-2.5 rounded-md border text-xs inline-flex items-center gap-1.5
 ...
 {isDragActive && (
 <div className="pointer-events-none absolute inset-0 rounded-lg border-2 border-[var(--accent)] bg-[var(--accent-subtle)]/80 flex items-center justify-center text-sm font-medium text-[var(--accent)]">
 释放以上传文件（支持多文件）
 </div>
 )}
 </div>
 ...
 {modelFallback ? (
 <div className="mt-1 px-1 text-[11px] text-[var(--warning)]">
 ...
 {!slashHintSeen && (
 <span className="ml-1 inline-flex items-center gap-1 rounded-full bg-[var(--accent-subtle)] px-1.5 py-0.5 text-[var(--accent)]">
