          ...
          <div className="flex items-center gap-2">
            {screen !== "status" && (
              <button
                ...
                className="p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 mr-1"
                aria-label="返回"
              >
                <ArrowLeft size={16} />
              </button>
  ...
  return (
    <div className="space-y-0.5">
      <div className="flex justify-between text-[11px]">
        <span className={isExhausted ? "text-red-500 font-medium" : "text-slate-500 dark:text-slate-400"}>
          {label}
        </span>
        <span
          className={
...
function StatusScreen({
      ...
      <div className="px-5 py-6 space-y-4">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            />
            <span className="text-sm font-medium text-slate-800 dark:text-slate-200">系统内置</span>
            <span
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400 mb-3">
            模式：<span className="text-slate-700 dark:text-slate-300">{activeModel?.model ?? "快速"}</span>
          </div>
          {builtinUsage && (
        ...
        <button
          onClick={onSwitch}
          className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl border hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors text-sm text-slate-600 dark:text-slate-400"
        >
          配置自己的密钥 / 切换服务商
  ...
  return (
    <div className="px-5 py-6 space-y-4">
      ...
      <button
        onClick={onSwitch}
        className="w-full flex items-center justify-between px-4 py-3 rounded-xl border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100 dark:border-blue-800 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/30 transition-colors text-sm font-medium"
      >
        配置自己的密钥
          ...
          <button
            ...
            className={`flex flex-col items-start p-4 rounded-xl border text-left hover:border-blue-300 hover:bg-blue-50/50 dark:hover:bg-blue-900/20 transition-colors ${
              p.configured
                ...
                : "border-slate-200 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800"
            }`}
          >
    ...
    <div className="px-5 py-5 space-y-4">
      {lockedConfig ? (
        <>
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50/70 dark:bg-slate-800 p-4 space-y-3 text-sm">
            <div>
              <div className="text-xs text-slate-400 dark:text-slate-500">接口模式</div>
            ...
            {!isOllama && (
              <div>
                <div className="text-xs text-slate-400 dark:text-slate-500">API Key</div>
            ...
            <div>
              <div className="text-xs text-slate-400 dark:text-slate-500">Base URL</div>
              <div className="mt-1 break-all text-slate-700 dark:text-slate-300">
                {provider.base_url || "默认端点"}
              </div>
            </div>
            <div>
              <div className="text-xs text-slate-400 dark:text-slate-500">当前模型</div>
              <div className="mt-1 text-slate-700 dark:text-slate-300">
      ...
      {!isOllama && (
        <div>
          <label className="text-xs text-slate-500 dark:text-slate-400 mb-1 block">密钥</label>
          <input
            type="password"
          ...
          <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-slate-800 p-5 shadow-2xl">
            ...
            <div className="mt-5 flex items-center justify-end gap-2">
              <button
                ...
                disabled={removing}
                className="rounded-xl border border-slate-200 dark:border-slate-700 px-4 py-2 text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50"
              >
                取消
              </button>
              <button
