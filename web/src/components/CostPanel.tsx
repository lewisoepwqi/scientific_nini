...
export default function CostPanel({ isOpen, onClose }: CostPanelProps) {
  ...
  return (
    ...
    >
      {/* 标签页切换 */}
      <div role="tablist" aria-label="成本统计" className="flex border-b border-slate-200 dark:border-slate-700">
        <button
          role="tab"
...
function StatCard({
  ...
  return (
    <div
      className={`bg-slate-50 dark:bg-slate-800 rounded-lg p-3 border border-slate-100 dark:border-slate-700 ${className}`}
    >
